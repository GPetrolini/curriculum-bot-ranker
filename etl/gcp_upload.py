...
def upload_raw_cvs_to_gcs(
    gcp_conn_id: str, bucket_name: str, local_folder: str, archive_folder: str
):
    """
    ...
    arquivos = [
        f for f in os.listdir(local_folder) if f.endswith(".pdf") or f.endswith(".docx")
    ]
